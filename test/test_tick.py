...
# import sys
# sys.path.insert(0, "c:/work/activitywatch/aw-matrix-client/src")
...
# class TestTickModuleImports(unittest.TestCase):

#     def test_succesful_launch_award(self):
#         pass


# class TestImportsInTickModule(unittest.TestCase):
...
#             self.assertTrue(name in dir(sys.modules['tick']))
...
#         test_module = sys.modules['test.test_tick']
#         main_module = sys.modules['tick']
